...
export default function Report() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      router.push("/"); // Redirigir a la página principal o a otra página después de enviar el reporte
    } catch (error) {
  ...
  return (
    <View className="bg-white mx-8 rounded-lg">
      <View className="flex flex-col m-4">
        <Text className="text-lg font-semibold my-2">Localidad: {localidad}</Text>
